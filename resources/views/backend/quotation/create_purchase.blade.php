                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        if($product_quotation->variant_id) {
                                                            $product_variant_data = \App\ProductVariant::select('item_code', 'additional_cost')->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)->first();
                                                    ...
                                                    <tr>
                                                        <?php
                                                            ...
                                                            $product_batch_data = \App\ProductBatch::select('batch_no', 'expired_date')->find($product_quotation->product_batch_id);
                                                        ?>
                                                        ...
                                                        @if($product_quotation->product_batch_id)
                                                        <td>
                                                            <input type="hidden" name="product_batch_id[]" value="{{$product_quotation->product_batch_id}}">

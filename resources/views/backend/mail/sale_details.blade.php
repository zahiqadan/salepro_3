...
<table style="border-collapse: collapse; width: 100%;">
	...
	<tbody>
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">{{number_format((float)($sale_data['total'][$key] / $sale_data['qty'][$key]), 2, '.', '')}}</td>
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">{{number_format((float)($sale_data['grand_total'] - $sale_data['paid_amount']), 2, '.', '')}}</td>
		</tr>
	</tbody>
</table>
